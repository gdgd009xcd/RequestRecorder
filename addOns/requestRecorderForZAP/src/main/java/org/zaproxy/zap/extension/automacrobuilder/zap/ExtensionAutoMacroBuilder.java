...
public final class ExtensionAutoMacroBuilder extends ExtensionAdaptor {
    ...
    private String AMBURL = "https://gdgd009xcd.github.io/RequestRecorder/";

    public static final ImageIcon A_TAB_ICON =
            DisplayUtils.getScaledIcon(
                    new ImageIcon(MyWorkPanel.class.getResource(ZAP_ICONS + "/R.png")));
    ...
    public void hook(ExtensionHook extensionHook) {
        ...
        extwrapper = new ExtensionActiveScanWrapper(this.pmtProvider, this.mbui);
        ...
        if (getView() != null) {
                    ...
                    .addPopupMenuItem(
                            new PopUpMenuItem(
                                    ...
                                    Constant.messages.getString(
                                            "autoMacroBuilder.PopUpItemSingleSend.title.text"),
                                    A_TAB_ICON));
            ...
            extensionHook
                    ...
                    .addWorkPanel(
                            new MyWorkPanel(
                                    extwrapper, this.mbui, "RequestRecorder", extensionHook));
    ...
    private AbstractPanel getStatusPanel() {
        if (statusPanel == null) {
            ...
            statusPanel.setName(
                    EnvironmentVariables.getZapResourceString("autoMacroBuilder.panel.title"));
