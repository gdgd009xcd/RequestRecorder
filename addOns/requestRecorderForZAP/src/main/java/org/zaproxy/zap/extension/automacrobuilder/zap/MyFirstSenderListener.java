...
public final class MyFirstSenderListener implements HttpSenderListener {
    ...
    public static final int DEFAULT_EXTENSION_LISTENER_ORDER =
            10000; // this value must be larger than ExtensionForcedUser.getListenerOrder()==9998
    ...
    MyFirstSenderListener(StartedActiveScanContainer startedcon) {
        ...
        ExtensionForcedUser extensionForcedUser =
                Control.getSingleton().getExtensionLoader().getExtension(ExtensionForcedUser.class);
    ...
    public void onHttpRequestSend(HttpMessage arg0, int arg1, HttpSender arg2) {
        try {
            ...
            if (this.startedcon.isThreadFromStartedActiveScanners(
                ...
                LOGGER4J.debug(
                        "onHttpRequestSend: no action. sender is not created by ExtensionActiveScanWrapper");
            }
        } finally {
        }
    }
