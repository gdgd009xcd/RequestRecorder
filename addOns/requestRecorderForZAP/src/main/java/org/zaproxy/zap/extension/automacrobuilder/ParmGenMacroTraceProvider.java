...
public class ParmGenMacroTraceProvider {
    ...
    // collecting set-Cookie header values
    // except originated from AutoMacroBuilder
    private CookieManager cookieManagerInAppScope;
    ...
    public <T> ParmGenMacroTrace getNewParmGenMacroTraceInstance(
        ...
        ParmGenMacroTrace newpmt =
                getBaseInstance(pmtParams.getTabIndex())
                        .createScanRunningInstance(sender, pmtParams, this);
    ...
    public void parseSetCookie(HttpMessage httpMessage) {
        ...
        for (HtmlParameter cookie : cookies) {
            // Set-Cookie: PHPSESSID=875cfa8439d7912bfda16b35e5cfa7df; path=/; expires=Fri,
            // 08-Dec-23 16:51:00 GMT;domain=localhost; HttpOnly; Secure;
            // cookieName = "PHPSESSID";
            // cookieValue = "875cfa8439d7912bfda16b35e5cfa7df";
            // cookieAttrs  = new HashSet<String>();
            // stored entire [name=value] string like following.
