...
spotless {
    java {
        ...
        targetExclude(listOf("**/automacrobuilder/**/generated/*.java", "**/automacrobuilder/**/view/*.java"))
    }
}
...
zapAddOn {
    addOnName.set("requestRecorderForZAP")
    ...
    manifest {
        ...
        url.set("https://gdgd009xcd.github.io/RequestRecorder/")
        repo.set("https://github.com/gdgd009xcd/RequestRecorder")
        ...
        helpSet {
            ...
            val resourcesPath = "org.zaproxy.zap.extension.automacrobuilder.zap.resources."
